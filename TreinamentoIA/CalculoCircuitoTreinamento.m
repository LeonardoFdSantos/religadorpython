...
valores_resultados_fim_linha_sem_compensacao(1, :) = string({'dd' 'tipoCurto' 'Potencia_Carga' 'IA_Sim' 'IB_Sim' 'IC_Sim' 'VA_Sim' 'VB_Sim' 'VC_Sim' 'VA_Entrada_TRIF' 'VB_Entrada_TRIF' 'VC_Entrada_TRIF' 'IA_Entrada_TRIF' 'IB_Entrada_TRIF' 'IC_Entrada_TRIF'});
valores_resultados_meio_linha_sem_compensacao(1, :) = string({'dd' 'n' 'tipoCurto' 'Potencia_Carga' 'IA_Sim' 'IB_Sim' 'IC_Sim' 'VA_Sim' 'VB_Sim' 'Vc_Sim' 'VA_Entrada_TRIF' 'VB_Entrada_TRIF' 'VC_Entrada_TRIF' 'IA_Entrada_TRIF' 'IB_Entrada_TRIF' 'IC_Entrada_TRIF'});
